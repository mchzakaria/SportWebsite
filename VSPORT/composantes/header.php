...
<body>
    <header class="container">
            ...
            ?>
                <div class="cnx">
                    <a href="<?= $home; ?>pages/login.php" class="btn">Log in</a>
                    <a href="<?= $home; ?>pages/SignUp.php" class="btn">Sign up</a>
                </div>
            ...
            ?>
                <div class="cnx">
                    <a href="<?= $home; ?>?d" class="btn">Déconnecter</a>
                </div>
  ...
  if(isset($_SESSION['alert'])){
    ...
    <?php
    }else if(isset($_SESSION['alert_type']) && $_SESSION['alert_type']=="error"){
        ?>
